    ...
    public partial class display : Form
    {
        ...
        public display(ref string sqlname1)
        {
            ...
            switch(sqlname1)
            {
                ...
                case "CustomerPO": { ShowName = "Customer PO"; pictureBox1.Image = imageList4.Images[0]; }break;
                case "MasterSetting": { ShowName = "Master Setting"; pictureBox1.Image = imageList4.Images[0]; }break;
                case "Warehouse": { ShowName = "Warehouse"; pictureBox1.Image = imageList4.Images[4]; }break;
                case "Packing": { ShowName = "Packing"; pictureBox1.Image = imageList4.Images[9]; }break;
                case "Production": { ShowName = "Production"; pictureBox1.Image = imageList4.Images[8]; }break;
                case "Planning": { ShowName = "Planning"; pictureBox1.Image = imageList4.Images[1]; }break;
                case "Sale": { ShowName = "Sales"; pictureBox1.Image = imageList4.Images[6]; }break;
                case "Summary": { ShowName = "Summary"; pictureBox1.Image = imageList4.Images[1]; }break;
